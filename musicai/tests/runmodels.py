    ...
    for model_dict in model_list.get('models'):
        if model_dict.get('is_enabled', True):
            ...
            if 1:  # model_name in ['MLP']:  # data_type in ['ngram_notes']:
                ...
                results.append([model_name, data_type, num_notes, actval, chords_in_ngram, scores])
...
if __name__ == "__main__":
    evaluate_models(sort=True, num_notes_val=4, ngramlength_val=3, directory=directories.PROCESSED_CHORDS)
